    ...
    if (file) {
      ...
      reader.onloadend = () => {
        ...
        img.onload = () => {
          ...
          const MAX_SIZE = 400; // Suficiente para avatares en la UI, reduce dramáticamente el peso
          let width = img.width;
          ...
          if (ctx) {
            ...
            // Convertir a WebP con 80% de calidad comprime enormemente y soporta transparencias
